...
const templates = [
  { id: 'health-basic', name: 'CareerFolio Health - Premium', category: 'Kesehatan & Medis', badgeType: 'health', desc: 'Template minimalis fokus pada rotasi klinis dan sertifikasi.', image: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?q=80&w=600&auto=format&fit=crop' },
  ...
  { id: 'agro-field', name: 'CareerFolio Agro - Field Expert', category: 'Pertanian & Lingkungan', badgeType: 'agro', desc: 'Fokus pada riset data, dokumentasi lapangan, dan yield prediction.', image: 'https://images.unsplash.com/photo-1592982537447-6f296d3f2ec4?q=80&w=600&auto=format&fit=crop' },
  { id: 'tech-civil', name: 'CareerFolio Tech - Constructor', category: 'Teknik Non-IT', badgeType: 'tech', desc: 'Sempurna untuk blueprint, CAD drawings, dan spesifikasi RAB.', image: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=600&auto=format&fit=crop' },
